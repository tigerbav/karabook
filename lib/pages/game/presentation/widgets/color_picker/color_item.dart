...
import 'package:karabookapp/pages/game/presentation/widgets/radial_progress_painter.dart';
                    ...
                    RepaintBoundary(
                      child: CustomPaint(
                        painter: RadialProgressPainter(
                          ...
                          bgColor: widget.color.computeLuminance() >= 0.4
                              ? _darken(widget.color, .2)
                              : _lighten(widget.color, .2),
